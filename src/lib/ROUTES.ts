...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/sign-in': never, '/sign-up': never, '/verify': never, '/[handle]': 'handle', '/[handle]/[twiddleId]': 'handle' | 'twiddleId', '/admin/settings': never, '/admin/users': never, '/settings': never, '/settings/interface': never, '/settings/privacy': never }
